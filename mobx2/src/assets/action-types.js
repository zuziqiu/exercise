...
// 画板属性相关
export const WHITEBOARD_CONTAINER = 'WHITEBOARD_CONTAINER' //画板容器
...
// 历史相关
export const WHITEBOARD_HISTORY_ADD_BRANCH = 'WHITEBOARD_HISTORY_ADD_BRANCH'
export const WHITEBOARD_HISTORY_TYPE_UPDATE = 'WHITEBOARD_HISTORY_TYPE_UPDATE'
...
export const WHITEBOARD_HISTORY_BACKWARE_ACTION = 'WHITEBOARD_HISTORY_BACKWARE_ACTION' //后退动作
export const WHITEBOARD_HISTORY_FORWARE_ACTION = 'WHITEBOARD_HISTORY_FORWARE_ACTION' //前进动作
export const WHITEBOARD_HISTORY_CLEAN_ACTION = 'WHITEBOARD_HISTORY_CLEAN_ACTION' //清空当前历史分支
...
// 客户端drawdata
// export const CLIENT_DRAW_DATA = 'CLIENT_DRAW_DATA' // 获取localstorage

// 资源重试
// export const UPDATE_ERROR_GROUP = 'UPDATE_ERROR_GROUP'
// 更新域名组
// export const UPDATE_CURRENT_HOST_GROUP = 'UPDATE_CURRENT_HOST_GROUP'

// PPT动画对象
export const UPDATE_PPT_ANIMATION_DATA = 'UPDATE_PPT_ANIMATION_DATA'
export const UPDATE_PPT_ANIMATION_URL = 'UPDATE_PPT_ANIMATION_URL'
export const UPDATE_PPT_STATE = 'UPDATE_PPT_STATE'
