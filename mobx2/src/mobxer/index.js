...
export const cousewareResource = (state = _STATE.cousewareResource, action) => {
  switch (action.type) {
...
// 页面涂鸦数据
export const pageDrawData = (state = _STATE.pageDrawData, action) => {
  switch (action.type) {
    // 新增画板 => { 10002: {}, 10003: {} ...}
...
// 页码[后期要新增画板统计]
export const page = (state = _STATE.page, action) => {
  switch (action.type) {
    // 切换PPT时的进度状态
    case TYPES.SWITCH_PAGE_STATUS:
...
// todo...
// ##################### 以下代码为示例 ##########################
export const testObject = (state = _STATE.testObject, action) => {
  switch (action.type) {
    case 'ADD':
      return state += 1
    default:
...
// export const objs = (state = _STATE.objs, action) => {
//   switch (action.type) {
//     case 'TOKEY':
...
//   }
// }
export const testArray = (state = _STATE.testArray, action) => {
  switch (action.type) {
    case 'ADDT':
      // var _k = []
...
// export const clientDrawData = (state = _STATE.clientDrawData, action) => {
//   switch (action.type) {
//     case TYPES.CLIENT_DRAW_DATA:
//       return Object.assign({}, state, action.payload.clientDrawData)
//     default:
//       return state
//   }
// }
...
export const sourceReLoad = (state = _STATE.sourceReLoad, action) => {
  switch (action.type) {
    ...
    //     //   }
    //     //   return state
    //     case TYPES.UPDATE_CURRENT_HOST_GROUP:
