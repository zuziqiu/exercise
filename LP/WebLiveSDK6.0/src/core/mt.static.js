...
STATIC.CMD.VIDEO_START = '103'; // 摄像头视频流打开
STATIC.CMD.VIDEO_STOP = '104' // 摄像头推流结束
STATIC.CMD.OPEN_CAMERA = '101'; //打开摄像头
STATIC.CMD.CLOSE_CAMERA = '102'; //摄像头关闭
STATIC.CMD.MODE_CHANGE = '151'; //模式切换
STATIC.CMD.DESKTOP_START = '201' //桌面视频流开始
STATIC.CMD.DESKTOP_STOP = '202' // 桌面视频流结束
...
// URL protocol
STATIC.PROTOCOL = (("https:" == document.location.protocol) ? "https://" : "https://");
const hostApi = Store.state()['api']['host']

// domain
var _hostTmp = window.location.host.match(/open-[\d]+\.talk-fun\.com/);
STATIC.APP_DOMAIN = _hostTmp ? _hostTmp[0] : hostApi || 'open.talk-fun.com';
...
// 媒体事件
STATIC.player.MAX_PULL_STREAM_ERROR = 'max_pull_stream_error'
...
STATIC.ROOM.WHITEBOARD_VERSION = '3.0.5'; // 画板版本

// 存储当前CAMERA-RTMP对象
STATIC.CAMERA_URL_STREAM = null;
// 大班低延迟
STATIC.LOWDELAY_MODE = 7
