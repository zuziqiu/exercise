...
export const graphicTempObject = {
  ...
  //     console.error('actionEvent.length', actionEvent.length)
  //     let _actionEvent = actionEvent.splice(0, 1)
  //     return new Promise((reslove, reject) => {
  //       // dispatch => obj
  //       typeof _actionEvent == 'function' && _actionEvent()
  //       reslove()
  //     }).then(() => {
  //       schedule.excuteAction()
  //     })
  //   } else {
