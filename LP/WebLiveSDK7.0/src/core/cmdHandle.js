...
// 发送指令到客户端
var iframeCross = require("../extends/iframeCross_v3.0");
// QT客户端传输
// postMessage 通信桥
...
let handle = {
  ...
  on: function (cmd, callback) {
    ...
    eventStore.put( cmd, callback)
  },
  // 调用
  get: function (cmd, response) {
    eventStore.emit(cmd, response)
  },
  // emit[发送]
