 ...
 *  });
 */
MT.main.prototype.finishInterface = function (callback) {
 ...
 *  })
 */
MT.main.prototype.beforeSocket = function (callback) {
 ...
 *  })
 */
MT.main.prototype.finishSocket = function (callback) {
 ...
 *  })
 */
MT.main.prototype.createdCameraPlayer = function (callback) {
 ...
 *  })
 */
MT.main.prototype.createdVideoPlayer = function (callback) {
 ...
 *  })
 */
MT.main.prototype.createdCoursewarePlayer = function (callback) {
 ...
 *  })
 */
MT.main.prototype.mounted = function (callback) {
 ...
 * @ignore
 */
MT.main.prototype.videoPlayer = function (containerId, playerId, callback) {
 ...
 * @ignore
 */
MT.main.prototype.mediaPlayer = (containerId, playerId, callback) => {
...
MT.main.prototype.init = function (access_token, callback) {
  ...
  room.init(
    ...
    function (initData) {
      ...
      if (initData) {
        MT.main.prototype.initDataObj = initData
        // 提交数据
 ...
 * @ignore
 */
MT.main.prototype.room = async function (retval, initcallback) {
  // Seter
  var d = retval,
    that = this,
    roomInfo = (MT.room = {})
 ...
 * @ignore
 */
MT.main.prototype.getStore = function () {
 ...
 */
MT.main.prototype.webFullScreenOther = function () {
  // 获取传入的id、类名，需要携带标识符
 ...
 * todo(object)
 */
MT.main.prototype.whiteboardResize = function (width, height) {
  if (liveControler.whiteboardResize) {
    return liveControler.whiteboardResize(width, height)
  }
}
...
// 点赞
MT.main.prototype.like = function (times, callback) {
