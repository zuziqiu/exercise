...
// videojs.swf 路径
try{
    global._videojsSwfPath = window.TF_getStaticHost("static-1.talk-fun.com/open/maituo/static/swf") || "static-1.talk-fun.com/open/maituo/static/swf";
}catch(err){
    global._videojsSwfPath = "static-1.talk-fun.com/open/maituo/static/swf";
}

global.__vodPlayerUrl__ = "";
if(window.location.href.indexOf("debug=list") > -1){
  global.__vodPlayerUrl__ = global._videojsSwfPath + "/debug/video-js.swf";
}else{
  global.__vodPlayerUrl__ = global._videojsSwfPath + "/video-js.swf";
}
...
var Player = (function (_Component) {
  ...
  Player.prototype.loadTech_ = function loadTech_(techName, source) {
    ...
    this.on(this.tech_, 'firstbufferinfo', this.firstBufferInfo_);
  ...
  /**
   * Flash firstbufferInfo
   * @private
   * @method swf.firstbufferinfo
   */
  Player.prototype.firstBufferInfo_ = function firstBufferInfo_() {
    var firstbufferinfo = this.techGet_('firstbufferinfo');
    this.trigger('firstbufferinfo', firstbufferinfo);
    return firstbufferinfo;
  };
...
var Flash = (function (_Tech) {
  ...
  /**
   * Get Firstbufferinfo in flash
   * 
   * @return {JSON-Object}
   */
  Flash.prototype.firstbufferinfo = function firstbufferinfo(){
    return this.el_.vjs_getProperty("firstbufferinfo");
  };
...
!function() {
  !function(a) {
        ...
        if (b) {
            ...
            b.options.flash.swf = c + __vodPlayerUrl__
        }
    } (window)
