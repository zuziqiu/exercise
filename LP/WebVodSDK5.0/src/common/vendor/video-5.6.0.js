...
var Flash = (function (_Tech) {
  ...
  Flash.prototype.createEl = function createEl() {
    ...
    if (!options.swf) {
      options.swf = '//open.talk-fun.com/open/maituo_v2/static/player/videojs/video-js.swf';
    }
...
!function() {
  !function(a) {
        ...
        if (b) {
            ...
            b.options.flash.swf = c + "open.talk-fun.com/open/maituo_v2/static/player/videojs/video-js.swf"
        }
    } (window)
