...
import * as sageTypes from '@/sdkStore/constants/sagaTypes'
...
const chat = {
  ...
  uploadFile: function (file, callback) {
    ...
    xhr.open("POST", STATIC.URL.PROTOCOL + "fp2.talk-fun.com/live/api/uploadImage.php?access_token=" + sdkStore.getState().room.access_token, true);
    xhr.send(fd);
  },
  // 聊天扩展
