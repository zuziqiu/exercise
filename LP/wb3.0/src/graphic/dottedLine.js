...
export class DottedLine extends graphicBase {
  ...
  createKlss (data) {
    ...
    if(data){
      ...
      //虚线中显示的实线长度
      let linkPartOne = 8 + parseInt(this.store.wbProperty.strokeWidth);
      //虚线中显示的间隔长度
      let linkPartTwo = 2 + parseInt(this.store.wbProperty.strokeWidth) * 3;
      ...
      this.Line.set({
        ...
        id: curUserId + '_' + new Date().getTime()  + '_' + 'd' + this.store.room.drawId,
