...
function addPro(){
  ...
  $uploadFiles=uploadFile($path);
    ...
    foreach($uploadFiles as $key=>$uploadFile){
      thumb($path."/".$uploadFile['name'],"../uploads/image_50/".$uploadFile['name'],50,50);
			thumb($path."/".$uploadFile['name'],"../uploads/image_220/".$uploadFile['name'],220,220);
			thumb($path."/".$uploadFile['name'],"../uploads/image_350/".$uploadFile['name'],350,350);
			thumb($path."/".$uploadFile['name'],"../uploads/image_800/".$uploadFile['name'],800,800);
		}
  }
