...
<body>
    ...
    <div class="content clearfix">
        ...
        <div class="menu">
            <div class="cont">
                ...
                <ul class="mList">
                    <li>
                        <h3><span onclick="show('menu1','change1',this)" data-option="+" id="change1">+商品管理</span></h3>
                    ...
                    <li>
                        <h3><span onclick="show('menu2','change2',this)" data-option="+" id="change2">+分类管理</span></h3>
                    ...
                    <li>
                        <h3><span  onclick="show('menu3','change3',this)" data-option="+" id="change3" >+订单管理</span></h3>
                    ...
                    <li>
                        <h3><span onclick="show('menu4','change4',this)" data-option="+" id="change4">+用户管理</span></h3>
                    ...
                    <li>
                        <h3><span onclick="show('menu5','change5',this)" data-option="+" id="change5">+管理员管理</span></h3>
                        <dl id="menu5" style="display:none;">
                         ...
                         <li>
                        <h3><span onclick="show('menu6','change6',this)" data-option="+" id="change6">+商品图片管理</span></h3>
    ...
    <script type="text/javascript">
    	function show(num,change,_this){
	    		var menu=document.getElementById(num);
	    		var change=document.getElementById(change);
                var _option = _this.getAttribute("data-option");
	    		if(_option=="+"){
	    				_this.setAttribute("data-option","-");
