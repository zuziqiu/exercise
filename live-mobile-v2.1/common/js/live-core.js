...
// SDK-JS-PACK
var defaultVersion = window.sdkVersion || "2.9";

// static host path
seajs.resPath = "static-1.talk-fun.com";
...
seajs.baseConfig = {
    ...
    // tmod模版加载路径
    templateUrl: base_path+"/live-mobile-v2.1/tpls/template.html",

    // 组件路径
    commonPath: base_path+"/live-mobile-v2.1/",
...
seajs.config({
    ...
    //Sea.js 基础路径
    base: seajs.baseConfig.basePath,

    //别名配置
    alias: {
        '$'           : seajs.baseConfig.commonPath + 'common/vendor/uglified/zepto/zepto-v1.0rc.amd',
        ...
        "barrager"    : seajs.baseConfig.commonPath + "common/vendor/barrager/jquery.barrager",
        "animate"     : seajs.baseConfig.commonPath + "common/vendor/animate/animate",
        // ==== SDK包 ====
        "SDK"         : seajs.baseConfig.SDK_PACK
    },
...
seajs.on('fetch', function(data) {
    // 调试模式
    if(seajs.baseConfig.debug){
        console.log("加载模块 ==> " + data.uri);
    }
});
